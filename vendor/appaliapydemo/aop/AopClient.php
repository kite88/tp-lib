...
class AopClient {
	...
	*/
	...
	function verify($data, $sign, $rsaPublicKeyFilePath, $signType = 'RSA') {
		...
		//file_put_contents('/www/coding_www/shichangtaocui.heifeng.xin/was.binglangnet.com/public/log/test.txt', "\n\r \n\r 成功与否".var_export($result, true), FILE_APPEND);
...
/** 
     ...
     * @author guofa.tgf
     */
	public function sdkExecute_zuwo($request) {
		$params = $request;
		...
		foreach ($params as $key => $value) {
			$params[$key] = $this->characet($value, $params['charset']);
		}
